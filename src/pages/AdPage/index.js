	...
	return (
		<PageContainer>
			...
			{adInfo.category && (
				<BreadCrumb>
					Você está aqui:
					<Link to="/">Home</Link>/<Link to={`/ad?state=${adInfo.stateName}`}>{adInfo.stateName}</Link>/
			...
			<PageArea>
				...
				<div className="rightSide">
					...
					{adInfo.userInfo && (
						<>
							<a href={`mailto:${adInfo.userInfo.email}`} target="_blank" rel="noreferrer" className="contactSellerLink">
								Fale com o vendedor
							</a>
